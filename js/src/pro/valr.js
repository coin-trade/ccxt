...
export default class valr extends valrRest {
    ...
    parseWsBalance(balanceWs) {
        ...
        const lendBorrow = Precise.stringAdd(this.safeString(balanceWs, 'lendReserved'), this.safeString(balanceWs, 'borrowReserved'));
        const used = Precise.stringAdd(lendBorrow, this.safeString(balanceWs, 'reserved'));
        const debt = Precise.stringSub(this.safeString(balanceWs, 'borrowedAmount'), this.safeString(balanceWs, 'borrowReserved'));
        if (code !== undefined) {
            result[code] = {
