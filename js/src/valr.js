...
import { ArgumentsRequired, AuthenticationError, BadRequest, BadSymbol, DuplicateOrderId, InsufficientFunds, InvalidOrder, NotSupported, NullResponse, OrderNotFound, } from './base/errors.js';
...
export default class valr extends Exchange {
    ...
    parseBalance(balances) {
        ...
        for (let i = 0; i < balances.length; i++) {
            ...
            const lendBorrow = Precise.stringAdd(this.safeString(balance, 'lendReserved'), this.safeString(balance, 'borrowReserved'));
            const used = Precise.stringAdd(lendBorrow, this.safeString(balance, 'reserved'));
            const debt = Precise.stringSub(this.safeString(balance, 'borrowedAmount'), this.safeString(balance, 'borrowReserved'));
            result[code] = {
    ...
    sign(path, api = 'public', method = 'GET', params = {}, headers = undefined, body = undefined) {
        ...
        if (api === 'private') {
            ...
            const signature = this.hmac(this.base64ToBinary(payloadBase64), this.base64ToBinary(this.stringToBase64(this.secret)), sha512, 'hex');
            signHeaders = {
                // 'Content-Type': 'application/json',
