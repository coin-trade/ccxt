...
class valr extends Exchange {
    ...
    public function fetch_ticker(string $symbol, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $params) {
            ...
            $response = Async\await($this->publicGetPairMarketsummary ($this->extend($request, $params)));
    ...
    public function fetch_order_book(string $symbol, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $limit, $params) {
            ...
            if ($this->check_required_credentials(false)) {
                ...
                $response = Async\await($this->publicGetPairOrderbook ($this->extend($queryParams, $params)));
            }
    ...
    public function fetch_l3_order_book(string $symbol, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $limit, $params) {
            ...
            if ($this->check_required_credentials(false)) {
                $response = Async\await($this->privateGetMarketdataPairOrderbookFull ($this->extend($queryParams, $params)));
            } else {
                $response = Async\await($this->publicGetPairOrderbookFull ($this->extend($queryParams, $params)));
            }
            $lastDateChange = $this->safe_string($response, 'LastChange');
            $timestamp = $this->parse8601($lastDateChange);
    ...
    public function fetch_permissions($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $response = Async\await($this->privateGetAccountApiKeysCurrent ($params));
    ...
    public function fetch_accounts($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
            ...
            $response = Async\await($this->privateGetAccountSubaccounts ($this->extend($query, $params)));
    ...
    public function fetch_order(string $id, ?string $symbol = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            if ($useClientOrderId) {
                ...
                $response = Async\await($this->privateGetOrdersPairCustomerorderidId ($this->extend($request, $params)));
            } else {
                $response = Async\await($this->privateGetOrdersPairOrderidId ($this->extend($request, $params)));
            }
            // {
    ...
    public function fetch_closed_order(string $id, ?string $symbol = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            if ($useClientOrderId) {
                $params = $this->omit($params, 'useClientId');
                $response = Async\await($this->privateGetOrdersHistorySummaryCustomerorderidId ($this->extend($request, $params)));
            } else {
                $response = Async\await($this->privateGetOrdersHistorySummaryOrderidId ($this->extend($request, $params)));
            }
            return $this->parse_order($response);
        }) ();
    }
    ...
    public function fetch_closed_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            Async\await($this->load_markets());
            $response = Async\await($this->privateGetOrdersHistory ($this->extend($query, $params)));
            // [array('orderId' => 'aa6dce9a-6acb-477f-9da8-223127e6b32d',
    ...
    public function create_order(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $type, $side, $amount, $price, $params) {
            ...
            if ($type === 'market') {
                ...
                $response = Async\await($this->privatePostOrdersMarket ($this->extend($body, $params)));
            } elseif ($type === 'limit') {
                ...
                $response = Async\await($this->privatePostOrdersLimit ($this->extend($body, $params)));
            } else {
    ...
    public function edit_order(string $id, string $symbol, string $type, string $side, ?float $amount = null, ?float $price = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($id, $symbol, $type, $side, $amount, $price, $params) {
            ...
            $response = Async\await($this->privatePutOrdersModify ($this->extend($orderFormat, $params)));
            return $this->parse_order(array(
    ...
    public function cancel_order(string $id, ?string $symbol = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            Async\await($this->privateDeleteOrdersOrder ($this->extend($orderFormat, $params)));
            return $this->parse_order(array(
                'orderUpdatedAt' => $this->iso8601($this->parse_date($this->safe_string($this->last_response_headers, 'Date'))),
    ...
    public function cancel_all_orders(?string $symbol = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $params) {
            ...
            if ($symbol === null) {
                ...
                $response = Async\await($this->privateDeleteOrdersPair ($this->extend($body, $params)));
            }
            $timestamp = $this->parse_date($this->safe_string($this->last_response_headers, 'Date'));
    ...
    public function fetch_trades(string $symbol, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            if ($this->check_required_credentials(false)) {
                $response = Async\await($this->privateGetMarketdataPairTradehistory ($this->extend($queryParams, $params)));
                // array(
                //     array(
                //       "price" => "43023",
                //       "quantity" => "0.01971316",
    ...
    public function fetch_my_trades(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = Async\await($this->privateGetAccountPairTradehistory ($this->extend($queryParams, $params)));
            // array(
            //     array(
            //       "price" => "29001",
            //       "quantity" => "0.00137926",
    ...
    public function fetch_deposit_address(string $code, $params = array ()): PromiseInterface {
        return Async\async(function () use ($code, $params) {
            ...
            if ($this->is_fiat($code)) {
                $response = Async\await($this->privateGetWalletFiatCurrencyDepositReference ($this->extend($currencyId, $params)));
                // array('reference' => 'USDGVVU6XR')
            } else {
                $response = Async\await($this->privateGetWalletCryptoCurrencyDepositAddress ($this->extend($currencyId, $params)));
                // {'currency' => 'BTC',
    ...
    public function fetch_deposits(?string $code = null, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($code, $since, $limit, $params) {
            ...
            if ($this->is_fiat($code)) {
                ...
                $response = Async\await($this->privateGetAccountTransactionhistory ($this->extend($queryParams, $params)));
                // [array(
                ...
                $response = Async\await($this->privateGetWalletCryptoCurrencyDepositHistory ($this->extend($queryParams, $params)));
                // array(
                //     array(
                //       "currencyCode" => "BTC",
    ...
    public function fetch_withdrawals(?string $code = null, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($code, $since, $limit, $params) {
            ...
            if ($this->is_fiat($code)) {
                ...
                $queryParams['currency'] = $currency['id'];
                $response = Async\await($this->privateGetWalletCryptoCurrencyWithdrawHistory ($this->extend($queryParams, $params)));
            // array(
            //     array(
            //       "currency" => "BTC",
    ...
    public function withdraw(string $code, float $amount, string $address, ?string $tag = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($code, $amount, $address, $tag, $params) {
            ...
            if ($this->is_fiat($code)) {
                ...
                $response = Async\await($this->privatePostWalletFiatCurrencyWithdraw ($this->extend($withdrawalBody, $params)));
            } else {
                $withdrawalBody = array(
                    'currency' => $currency['id'],
                    'address' => $address,
                ...
                $response = Async\await($this->privatePostWalletCryptoCurrencyWithdraw ($this->extend($withdrawalBody, $params)));
            }
    ...
    public function fetch_cross_borrow_rates($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
            Async\await($this->load_markets());
            $response = Async\await($this->privateGetLoansRates ($params));
            $results = array();
            for ($i = 0; $i < count($response); $i++) {
    ...
    public function fetch_borrow_interest(?string $code = null, ?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        return Async\async(function () use ($code, $symbol, $since, $limit, $params) {
            ...
            $response = Async\await($this->privateGetBorrowsCurrencyHistory (($this->extend($currencyId, $params))));
            // [
            //     array(
            //         'currency' => 'USDC',
    ...
    public function transfer(string $code, float $amount, string $fromAccount, string $toAccount, $params = array ()): PromiseInterface {
        return Async\async(function () use ($code, $amount, $fromAccount, $toAccount, $params) {
            ...
            Async\await($this->privatePostAccountSubaccountsTransfer (($this->extend($query, $params))));
    ...
    public function fetch_transfers(?string $code = null, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($code, $since, $limit, $params) {
            ...
            $response = Async\await($this->privateGetAccountTransactionhistory ($this->extend($query, $params)));
    ...
    public function fetch_open_interest(string $symbol, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $params) {
             ...
             */
            Async\await($this->load_markets());
            $response = Async\await($this->publicGetFuturesInfo ($params));
    ...
    public function fetch_positions(?array $symbols = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbols, $params) {
            Async\await($this->load_markets());
            $response = Async\await($this->privateGetPositionsOpen ($params));
