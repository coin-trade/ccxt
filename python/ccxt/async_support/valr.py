...
class valr(Exchange, ImplicitAPI):
 ...
 @param {{}} [params={}] extra parameters specific to the exchange API endpoint
    ...
    async def fetch_markets(self, params={}):
        ...
        """
        markets = await self.publicGetPairs(params)
        # [
        #     {'symbol': 'ENJUSDC',
        #     'baseCurrency': 'ENJ',
        #     'quoteCurrency': 'USDC',
    ...
    async def fetch_tickers(self, symbols: List[str] = None, params={}) -> Tickers:
        ...
        response = await self.publicGetMarketsummary(params)
        # [
        #     {
        #       "currencyPair": "BTCZAR",
        #       "askPrice": "520000",
    ...
    async def fetch_ticker(self, symbol: str, params={}) -> Ticker:
        ...
        response = await self.publicGetPairMarketsummary(self.extend(request, params))
    ...
    async def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        if self.check_required_credentials(False):
            response = await self.privateGetMarketdataPairOrderbook(self.extend(queryParams, params))
        else:
            response = await self.publicGetPairOrderbook(self.extend(queryParams, params))
    ...
    async def fetch_l3_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        """
        ...
        if self.check_required_credentials(False):
            response = await self.privateGetMarketdataPairOrderbookFull(self.extend(queryParams, params))
        else:
            response = await self.publicGetPairOrderbookFull(self.extend(queryParams, params))
        lastDateChange = self.safe_string(response, 'LastChange')
        timestamp = self.parse8601(lastDateChange)
    ...
    async def fetch_permissions(self, params={}):
        ...
        response = await self.privateGetAccountApiKeysCurrent(params)
    ...
    async def fetch_accounts(self, params={}) -> List[Account]:
        ...
        response = await self.privateGetAccountSubaccounts(self.extend(query, params))
    ...
    async def fetch_order(self, id: str, symbol: Str = None, params={}) -> Order:
        ...
        if useClientOrderId:
            ...
            response = await self.privateGetOrdersPairCustomerorderidId(self.extend(request, params))
        else:
            response = await self.privateGetOrdersPairOrderidId(self.extend(request, params))
        # {
    ...
    async def fetch_open_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        """
        await self.load_markets()
        response = await self.privateGetOrdersOpen(params)
    ...
    async def fetch_closed_order(self, id: str, symbol: Str = None, params={}) -> Order:
        ...
        if useClientOrderId:
            params = self.omit(params, 'useClientId')
            response = await self.privateGetOrdersHistorySummaryCustomerorderidId(self.extend(request, params))
        else:
            response = await self.privateGetOrdersHistorySummaryOrderidId(self.extend(request, params))
        return self.parse_order(response)
    ...
    async def fetch_closed_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        await self.load_markets()
        response = await self.privateGetOrdersHistory(self.extend(query, params))
        # [{'orderId': 'aa6dce9a-6acb-477f-9da8-223127e6b32d',
    ...
    async def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}) -> Order:
        ...
        if type == 'market':
            ...
            response = await self.privatePostOrdersMarket(self.extend(body, params))
        elif type == 'limit':
            ...
            response = await self.privatePostOrdersLimit(self.extend(body, params))
        else:
    ...
    async def create_orders(self, orders: List[OrderRequest], params={}) -> List[Order]:
        ...
        # response = await self.privatePostBatchOrders()
    ...
    async def edit_order(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: Num = None, price: Num = None, params={}) -> Order:
        ...
        response = await self.privatePutOrdersModify(self.extend(orderFormat, params))
        return self.parse_order({
    ...
    async def cancel_order(self, id: str, symbol: Str = None, params={}) -> Order:
        ...
        await self.privateDeleteOrdersOrder(self.extend(orderFormat, params))
        return self.parse_order({
            'orderUpdatedAt': self.iso8601(self.parse_date(self.safe_string(self.last_response_headers, 'Date'))),
    ...
    async def cancel_all_orders(self, symbol: Str = None, params={}) -> List[Order]:
        ...
        if symbol is None:
            ...
            response = await self.privateDeleteOrdersPair(self.extend(body, params))
        timestamp = self.parse_date(self.safe_string(self.last_response_headers, 'Date'))
    ...
    async def fetch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        if self.check_required_credentials(False):
            response = await self.privateGetMarketdataPairTradehistory(self.extend(queryParams, params))
            # [
            #     {
            #       "price": "43023",
            #       "quantity": "0.01971316",
    ...
    async def fetch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        if since is not None:
            queryParams['startTime'] = self.iso8601(since)
        response = await self.privateGetAccountPairTradehistory(self.extend(queryParams, params))
        # [
        #     {
        #       "price": "29001",
        #       "quantity": "0.00137926",
    ...
    async def fetch_trading_fees(self, params={}) -> TradingFees:
        ...
        """
        await self.load_markets()
        response = await self.privateGetAccountFeesTrade(params)
    ...
    async def load_trading_fees(self, params={}):
        await self.load_markets()
    ...
    async def fetch_deposit_address(self, code: str, params={}) -> DepositAddress:
        ...
        if self.is_fiat(code):
            response = await self.privateGetWalletFiatCurrencyDepositReference(self.extend(currencyId, params))
            # {'reference': 'USDGVVU6XR'}
        else:
            response = await self.privateGetWalletCryptoCurrencyDepositAddress(self.extend(currencyId, params))
            # {'currency': 'BTC',
    ...
    async def fetch_deposits(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Transaction]:
        ...
        if self.is_fiat(code):
            ...
            response = await self.privateGetAccountTransactionhistory(self.extend(queryParams, params))
            # [{
            ...
            response = await self.privateGetWalletCryptoCurrencyDepositHistory(self.extend(queryParams, params))
            # [
            #     {
            #       "currencyCode": "BTC",
    ...
    async def fetch_withdrawals(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Transaction]:
        ...
        if self.is_fiat(code):
            ...
            queryParams['currency'] = currency['id']
            response = await self.privateGetWalletCryptoCurrencyWithdrawHistory(self.extend(queryParams, params))
        # [
        #     {
        #       "currency": "BTC",
    ...
    async def withdraw(self, code: str, amount: float, address: str, tag: Str = None, params={}) -> Transaction:
        ...
        if self.is_fiat(code):
            ...
            response = await self.privatePostWalletFiatCurrencyWithdraw(self.extend(withdrawalBody, params))
        else:
            withdrawalBody = {
                'currency': currency['id'],
                'address': address,
            ...
            response = await self.privatePostWalletCryptoCurrencyWithdraw(self.extend(withdrawalBody, params))
    ...
    async def fetch_cross_borrow_rates(self, params={}) -> CrossBorrowRates:
        await self.load_markets()
        response = await self.privateGetLoansRates(params)
        results = {}
        for i in range(0, len(response)):
    ...
    async def fetch_borrow_interest(self, code: Str = None, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        response = await self.privateGetBorrowsCurrencyHistory((self.extend(currencyId, params)))
        # [
        #     {
        #         'currency': 'USDC',
    ...
    async def transfer(self, code: str, amount: float, fromAccount: str, toAccount: str, params={}) -> TransferEntry:
        ...
        await self.privatePostAccountSubaccountsTransfer((self.extend(query, params)))
    ...
    async def fetch_transfers(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> List[TransferEntry]:
        ...
        if limit is not None:
            query['limit'] = limit
        response = await self.privateGetAccountTransactionhistory(self.extend(query, params))
    ...
    async def fetch_open_interest(self, symbol: str, params={}) -> OpenInterest:
        ...
        """
        await self.load_markets()
        response = await self.publicGetFuturesInfo(params)
    ...
    async def fetch_positions(self, symbols: Strings = None, params={}) -> List[Position]:
        await self.load_markets()
        response = await self.privateGetPositionsOpen(params)
